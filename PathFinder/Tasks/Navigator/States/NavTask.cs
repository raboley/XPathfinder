...
using PathFinder.Tasks.Nav.States;
using System;

namespace PathFinder.Tasks.Nav
{
    /// <summary>
    /// Class NavTask. Implements the <see cref="PathFinder.Tasks.TaskBase"/> Implements the <see cref="PathFinder.Contracts.ITask"/>
    /// </summary>
    /// <seealso cref="PathFinder.Tasks.TaskBase"/>
    /// <seealso cref="PathFinder.Contracts.ITask"/>
    public class NavTask : TaskBase, ITask
    {
        /// <summary>
